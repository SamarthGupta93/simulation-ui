...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded p-1 text-vz-gray-400 hover:text-vz-gray-700 focus:outline-none focus:ring-2 focus:ring-vz-red">
        <X size={16} />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('text-base font-semibold text-vz-gray-900', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn('text-sm text-vz-gray-500', className)}
    {...props}
  />
))
